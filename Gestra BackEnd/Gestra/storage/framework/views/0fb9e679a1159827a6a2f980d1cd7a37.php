...
<div class="main">
    <div class="intro">
        ...
        <div class="intro-img">
            <img src="<?php echo e(asset('assets/Mascot.png')); ?>" height="500px" alt="Mascot">
        </div>
    </div>
    ...
    <div class="konten">
        ...
        <div class="item">
            <div class="gesture">
                <img src="<?php echo e(asset('assets/Sibi.png')); ?>" alt="">
                <h2>
            ...
            <div class="tts">
                <img src="<?php echo e(asset('assets/STT.png')); ?>" alt="">
                <h2>
                    Speech to text untuk memudahkan komunikasi <br>
                    <a href="<?php echo e(route('stt')); ?>"><button>Coba</button></a>
                </h2>
            </div>

            <div class="forum">
                <img src="<?php echo e(asset('assets/Forum.png')); ?>" alt="">
                <h2>
    ...
    <div class="profil">
        ...
        <div id="image-track">
            <div class="card">
                <img class="image" src="<?php echo e(asset('assets/Member/Rafa.jpg')); ?>" draggable="false">
                <h2>Rafa Mufid ‘Aqila</h2>
                <h3>Motto:<br>"Apa adanya dan adanya apa"</h3>
            </div>

            <div class="card">
                <img class="image" src="<?php echo e(asset('assets/Member/bella.jpg')); ?>" draggable="false">
                <h2>Riyanda Wiesya Bella</h2>
                <h3>Motto:<br>"Hidup seperti larry~"</h3>
            </div>

            <div class="card">
                <img class="image" src="<?php echo e(asset('assets/Member/Aulya.jpg')); ?>" draggable="false">
                <h2>Shinta Alya Aulya Ningrum</h2>
                 <h3>Motto : <br> "Kalau gagal, coba lagi kalau gagal lagi, salahin zodiak"</h3>
            </div>

            <div class="card">
                <img class="image" src="<?php echo e(asset('assets/Member/Array.jpeg')); ?>" draggable="false">
                <h2>Muhammad Arrayan Fikri</h2>
                <h3>Motto:<br>"Rock and Stone!"</h3>
            </div>

            <div class="card">
                <img class="image" src="<?php echo e(asset('assets/Member/Yopi.jpg')); ?>" draggable="false">
                <h2>Yappier Albertus Febriandi Krisna Putra</h2>
                <h3>Motto:<br>"Selagi ada jalan, jalanin"</h3>
            </div>

            <div class="card">
                <img class="image" src="<?php echo e(asset('assets/Member/Alya.jpg')); ?>" draggable="false">
...
<?php /**PATH D:\Kuliah\Semester 5\Perancangan dan Pemrograman WEB\Tubes_GestraWEB\Gestra-Web\Gestra BackEnd\Gestra\resources\views/home.blade.php ENDPATH**/ ?>